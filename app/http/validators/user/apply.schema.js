...
const createApplicationSchema = Joi.object({
    name : Joi.string().min(3).max(30).error(createError.BadRequest("نام به صورت صحیح وارد نشده است")),
    degree : Joi.string().min(10).max(100).error(createError.BadRequest("میزان تحصیلات به صورت صحیح وارد نشده است")),
